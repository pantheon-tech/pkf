 ...
 */
export type BuiltInTemplateName = 'readme' | 'guide' | 'guide-user' | 'guide-developer' | 'adr' | 'spec' | 'specification' | 'proposal' | 'changelog' | 'todo' | 'issues' | 'api' | 'api-reference' | 'architecture' | 'design-doc' | 'claude' | 'contributing';
/**
