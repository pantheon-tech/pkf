...
export class TemplateManager {
    ...
    async loadTemplate(templateName) {
        ...
        try {
            ...
            if (error.code === 'ENOENT') {
                throw new Error(`Template '${templateName}' not found in ${this.templateDir}${this.customTemplateDir ? ` or ${this.customTemplateDir}` : ''}`);
            }
            throw error;
        }
    }
     ...
     * ```
     */
    generateBuiltInContent(docType, title) {
