 ...
 * ```
 */
export function processTemplate(template, variables, options) {
 ...
 * ```
 */
export function extractVariables(template, delimiters) {
 ...
 * ```
 */
export function createTemplate(content, replacements, delimiters) {
    const [openDelim, closeDelim] = delimiters ?? ['{{', '}}'];
