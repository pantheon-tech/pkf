 ...
 */
export type { TemplateVariables, TemplateProcessorOptions, ProcessedTemplate, } from '../templates/types.js';
/**
...
export interface ITemplateProcessor {
    ...
    renderTemplate(templateName: string, variables: Record<string, string | number | boolean | undefined>): Promise<{
        content: string;
