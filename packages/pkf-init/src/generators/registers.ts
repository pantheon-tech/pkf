...
export class RegisterInitializer {
   ...
   */
  async initialize(): Promise<InitializedRegisters> {
...
`;
   ...
   */
  private createChangelog(): string {
    const date = this.getDate();
